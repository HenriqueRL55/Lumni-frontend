    ...
    return (
        <>
            ...
            <Container>
                ...
                <FilterRow>
                    <FilterHeader0>Filtrar metas por Nível</FilterHeader0>
                    <FilterColumn0>
                        <Autocomplete
                            // {...defaultPropsYear}
                            id="year-selector"
                    ...
                    <FilterHeader1>Filtrar metas por Categoria</FilterHeader1>
                    <FilterColumn1>
                        <Autocomplete
                            //   {...defaultPropsState}
                            id="state-selector"
                    ...
                    <FilterHeader2>Filtrar metas por Usuário</FilterHeader2>
                    <FilterColumn2>
                        <Autocomplete
                            // {...defaultPropsSa}
                            id="sa-selector"
